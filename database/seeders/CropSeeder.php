...
class CropSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Crop::create([
            ...
            'Planting Method'=>' Cut the seed potatoes into pieces, Plant the pieces about 3-4 inches deep in rows,
                                spaced about 12-15 inches apart, with 2-3 feet between rows.',
            ...
            'Planting Tips'=>'Choose a sunny location with well-draining soil for planting potatoes.
                              Before planting, prepare the soil by adding organic matter such as compost or aged manure to improve soil fertility and structure.
                              When cutting seed potatoes, ensure that each piece has at least one eye or sprout to promote healthy growth.
                              Hill soil around the base of the potato plants when they reach about 6-8 inches tall.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Plant sweet corn in a sunny location with well-draining soil that has been amended with compost or organic matter.
                              Plant corn in blocks rather than single rows to ensure good pollination.
                              Thin seedlings to ensure proper spacing, and weed regularly to reduce competition for nutrients and water.
                              Consider planting early, mid, and late-season varieties to extend your harvest period.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Choose a sunny location with well-draining soil for planting green beans.
                              Plant bush varieties for smaller spaces or container gardening, and pole varieties for vertical growth and higher yields.
                              Provide support for pole beans with trellises, stakes, or teepees to keep the plants upright and facilitate harvesting.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Choose a sunny location with well-draining soil for planting peppers.
                              Space pepper plants about 18-24 inches apart in rows spaced 24-36 inches apart, depending on the variety,s size.
                              Provide support for tall or heavy-bearing pepper varieties with stakes or cages to prevent the plants from bending or breaking under the weight of the fruit.'
        ]);
        ...
        Crop::create([
            ...
            'Fertilizers'=>' balanced fertilizer with a higher potassium content',
            'Planting Tips'=>'Choose a sunny location with well-draining soil for planting watermelons.
                                Plant watermelon seeds in hills or rows, spacing them about 2-3 feet apart within the row and allowing 6-8 feet between rows.
                                Provide support for growing watermelons, such as trellises or slings, to support the weight of the fruit and prevent rotting.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Choose a sunny location with well-draining soil for planting sunflowers.
                                Plant sunflower seeds in rows or groups, spacing them according to the variety,s mature size.
                                Provide support for tall varieties of sunflowers with stakes or trellises to prevent them from toppling over in windy conditions.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Choose a location with partial shade for planting lettuce in hot climates, as it prefers cooler temperatures.
                                Plant lettuce seeds shallowly and keep the soil consistently moist until germination occurs.
                                Succession plant lettuce every 2-3 weeks for a continuous harvest throughout the growing season'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Choose a sunny location with well-draining soil for planting radishes.
                                Plant radish seeds shallowly and keep the soil consistently moist until germination occurs.
                                Succession plant radishes every 2-3 weeks for a continuous harvest throughout the growing season.'
        ]);
        ...
        Crop::create([
            ...
            'Fertilizers'=>'balanced fertilizer with a higher phosphorus content',
            'Planting Tips'=>'Choose a sunny location with well-draining soil for planting squash.
                                Plant squash seeds in hills or rows, spacing them according to the variety,s mature size.
                                Provide support for vining varieties of squash with trellises or cages to keep the fruit off the ground and prevent rotting.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Choose a sunny to partially shaded location with well-draining soil for planting kale.
                                Plant kale seeds shallowly and keep the soil consistently moist until germination occurs.
                                Succession plant kale every 2-3 weeks for a continuous harvest throughout the growing season.'
        ]);
        ...
        Crop::create([
            ...
            'Fertilizers'=>' can thrive in average soil without additional fertilization',
            'Planting Tips'=>'Choose a partially shaded location with well-draining soil for planting spinach, especially in warmer climates.
                                Plant spinach seeds shallowly and keep the soil consistently moist until germination occurs.
                                Succession plant spinach every 2-3 weeks for a continuous harvest throughout the growing season.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Method'=>' planted as dormant bare-root or container-grown trees.
                                    Dig a hole wide enough and deep enough to accommodate the roots without bending or crowding',
            ...
            'Planting Tips'=>'Choose a sunny location with well-draining soil for planting fruit trees.
                                Plant trees on a slight mound or raised bed to improve drainage and prevent waterlogging.
                                Mulch around the base of fruit trees to conserve moisture, suppress weeds, and regulate soil temperature.'
        ]);
        ...
        Crop::create([
            ...
            'Fertilizers'=>'balanced fertilizer with a higher nitrogen content',
            'Planting Tips'=>'Choose a sunny to partially shaded location with well-draining soil for planting cabbage.
                                Plant cabbage seeds shallowly and keep the soil consistently moist until germination occurs.
                                Succession plant cabbage every 2-3 weeks for a continuous harvest throughout the growing season'
        ]);
        ...
        Crop::create([
            ...
            'Planting Method'=>'Carrots are best grown from seeds directly sown into the garden soil. ,Sow carrot seeds thinly,
                                about 1/4 inch deep and 1 inch apart in rows spaced 12-18 inches apart.',
            ...
            'Fertilizers'=>'incorporate compost or well-rotted manure into the soil to improve fertility.
                            Avoid using high-nitrogen fertilizers',
            'Planting Tips'=>'Mulch around carrot plants to conserve moisture, suppress weeds, and prevent soil crusting.
                              Keep the planting area free from weeds, as competition can hinder carrot growth.
                              Consider planting companion plants such as onions, leeks, or radishes to deter pests and maximize garden space'
        ]);
        ...
        Crop::create([
            ...
            'Planting Method'=>'Directly sow parsley seeds into well-drained soil, about 1/4 inch deep.
                                Space seeds or seedlings 6 to 8 inches apart in rows spaced 12 to 18 inches apart.',
            ...
            'Fertilizers'=>'Parsley is a light feeder and does not require heavy fertilization.
                            Incorporate organic compost into the soil before planting for added nutrients.',
            'Planting Tips'=>'Parsley seeds can take several weeks to germinate, so be patient.
        ...
        Crop::create([
            ...
            'Planting Method'=>'Dig planting holes about 2 feet apart in rows spaced 3 to 4 feet apart.
                                Plant tomato transplants deep, burying the stem up to the first set of leaves.',
            ...
            'Planting Tips'=>'Provide support for tomato plants with stakes, cages, or trellises to prevent sprawling.
                              Prune tomato plants to improve air circulation and reduce disease risk.
                              Mulch around tomato plants to conserve moisture and suppress weeds.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Provide support for melon vines with trellises or slings to prevent fruit from touching the ground.
                              Mulch around melon plants to conserve moisture, suppress weeds, and keep fruits clean.'
        ]);
        ...
        Crop::create([
            ...
            'Fertilizers'=>'Amend the soil with compost or well-rotted manure before planting.',
            'Planting Tips'=>'Provide support for cucumber vines with trellises or cages to save space and keep fruits off the ground.
                              Harvest cucumbers regularly to encourage continuous fruiting.
                              Mulch around cucumber plants to conserve moisture, suppress weeds, and keep fruits clean.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Plant lavender in raised beds or containers to improve drainage in heavy soil.
                              Prune lavender plants lightly after flowering to promote bushier growth and prevent legginess.
                              Mulch around lavender plants with gravel or crushed stone to suppress weeds and retain moisture.'
        ]);
        ...
        Crop::create([
            ...
            'Fertilizers'=>'Amend the soil with compost or well-rotted manure before planting.',
            'Planting Tips'=>'Plant rosemary in containers or raised beds if you have heavy or poorly drained soil.
                              Prune rosemary regularly to maintain its shape and promote bushy growth.
                              Harvest rosemary sprigs as needed, but avoid removing more than one-third of the plants growth at once.'
        ]);
        ...
        Crop::create([
            ...
            'Fertilizers'=>'Amend the soil with compost or well-rotted manure before planting.',
            'Planting Tips'=>'Plant thyme in containers or raised beds if you have heavy or poorly drained soil.
                              Prune thyme regularly to maintain its shape and promote bushy growth.
                              Harvest thyme sprigs as needed, but avoid removing more than one-third of the plant,s growth at once.'
        ]);
        ...
        Crop::create([
            ...
            'Fertilizers'=>'Amend the soil with compost or well-rotted manure before planting.',
            'Planting Tips'=>'Plant sage in containers or raised beds if you have heavy or poorly drained soil.
                              Prune sage regularly to maintain its shape and promote bushy growth.
                              Harvest sage leaves as needed, but avoid removing more than one-third of the plant,s growth at once.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Plant hydrangeas in locations with morning sun and afternoon shade to protect them from hot afternoon sun.
                              Mulch around hydrangea plants to conserve moisture, suppress weeds, and maintain even soil temperature.'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Choose viburnum varieties suited to your specific climate and soil conditions.
                              Prune viburnums selectively to maintain their natural shape and promote flowering.
                              Mulch around viburnum plants to conserve moisture, suppress weeds, and maintain even soil temperature..'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Mulch around rhododendron plants with pine bark or shredded leaves to conserve moisture and suppress weeds.
                              Prune rhododendrons after flowering to remove spent blooms and shape the plant..'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Mulch around azalea plants with pine bark or shredded leaves to conserve moisture and suppress weeds.
P                             rune azaleas after flowering to remove spent blooms and shape the plant'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Mulch around blueberry plants with pine bark or sawdust to conserve moisture and suppress weeds.
                              Prune blueberry bushes annually to remove old wood and stimulate new growth..'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Choose cranberry varieties suited to your climate and soil conditions.
                              Monitor water levels closely to prevent drought stress or waterlogging.
                              Harvest cranberries when they reach full color and firmness, typically in the fall'
        ]);
        ...
        Crop::create([
            ...
            'Planting Tips'=>'Plant pitcher plants in locations with full sun to partial shade and high humidity.
                              Avoid disturbing the delicate roots of pitcher plants during planting or transplanting.
                              Remove dead or dying pitchers regularly to maintain plant health and appearance.'
        ]);
